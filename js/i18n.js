...
(function () {
  ...
  var translations = {
    ...
    en: {
      ...
      'svc.rct_desc':         'Painless root canal treatment in Vejalpur, Ahmedabad — rotary technique, completed in 1–2 visits. Save your natural tooth quickly and comfortably.',
      'svc.whitening_title':  'Teeth Whitening',
      'svc.whitening_desc':   'Professional teeth whitening at our Vejalpur clinic — noticeably brighter results in a single session.',
      'svc.implants_title':   'Tooth Extractions',
      'svc.implants_desc':    'Safe, comfortable tooth extractions in Ahmedabad — gentle care with fast, smooth recovery.',
      'svc.scaling_title':    'Scaling & Polishing',
      'svc.scaling_desc':     'Dental scaling and polishing in Vejalpur — remove plaque and tartar for healthy gums and fresh breath.',
      'svc.smile_title':      'Smile Designing',
      'svc.smile_desc':       'Custom smile makeovers in Ahmedabad — veneers, bonding, whitening — tailored to your face and goals.',
      'svc.crowns_title':     'Crowns & Bridges',
      'svc.crowns_desc':      'High-quality ceramic crowns and bridges in Vejalpur — seamlessly matched to your existing teeth.',
      'svc.ortho_title':      'Orthodontics / Braces',
      'svc.ortho_desc':       'Braces and clear aligners for children and adults at our Vejalpur clinic. Straight teeth for life.',
      'svc.paeds_title':      'Paediatric Dentistry',
      'svc.paeds_desc':       'Child-friendly paediatric dentistry in Vejalpur, Ahmedabad — building healthy dental habits from a young age.',
      'svc.gum_title':        'Gum Disease Treatment',
      'svc.gum_desc':         'Expert gum disease treatment in Vejalpur, Ahmedabad. Dr. Disha treats gingivitis, periodontitis, and gum recession with gentle, effective protocols.',
      'svc.fillings_title':   'Dental Fillings And Restorations',
      'svc.fillings_desc':    'Tooth-colored fillings and cavity repairs in Ahmedabad — restore damaged teeth with durable, natural-looking results.',
